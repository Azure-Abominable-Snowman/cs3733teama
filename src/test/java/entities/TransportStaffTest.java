 ...
 */
public class TransportStaffTest {
    List<String> languages = Arrays.asList("English");
    TransportStaff staff1 = new TransportStaff("John","Smith","+16666666666",
            true, languages);
    ...
    public void getServiceType() throws Exception {
        assertEquals(ServiceStaff.TRANS, staff1.getServiceType());
    }
    ...
    public void setSpokenLanguages() throws Exception {
        List<String> languages2 = Arrays.asList("English", "Spanish");
