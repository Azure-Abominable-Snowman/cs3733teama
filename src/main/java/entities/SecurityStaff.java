 ...
 */
public class SecurityStaff implements ServiceStaff{
    ...
    public SecurityStaff(String firstName, String lastName, String phoneNumber, boolean isAvailable, List<String> languages){
    ...
    public String getServiceType(){ return ServiceStaff.SEC; }
