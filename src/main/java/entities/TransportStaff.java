 ...
 */
public class TransportStaff implements ServiceStaff {
    ...
    public TransportStaff(String firstName, String lastName, String phoneNumber, boolean isAvailable, List<String> languages){
    ...
    public String getServiceType(){ return ServiceStaff.TRANS; }
