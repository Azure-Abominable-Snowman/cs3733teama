 ...
 */
public class MaintenanceStaff implements ServiceStaff {
    ...
    public MaintenanceStaff(String firstName, String lastName, String phoneNumber, boolean isAvailable, List<String> languages){
    ...
    public String getServiceType(){ return ServiceStaff.MAIN; }
