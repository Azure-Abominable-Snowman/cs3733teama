...
public class InterpreterStaff implements ServiceStaff{
    ...
    public InterpreterStaff(String firstName, String lastName, String phoneNumber, boolean isAvailable, List<String> languages){
    ...
    public String getServiceType(){ return ServiceStaff.INTR; }
